...
///   1. The rocjitsu launcher enables DBT guest mode from RJ_CONFIG.
...
///      the host ISA configured in RJ_CONFIG, and loaded on the host agent.
...
TEST(HsaHooksTest, TranslateGfx950Mfma16x16ThroughToolsLib) {
  ...
  // hook maps execution-facing calls for this agent to the host from RJ_CONFIG.
